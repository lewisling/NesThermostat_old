package net.valentinc.CircularSeekBar;
 ...
 *
 *
 * This custom view/widget was ins***REMOVED***red and guided by:
 *
...
import net.valentinc.nesthermostat.R;

public class CircularSeekBar extends View {

    /**
     * Used to scale the dp units to ***REMOVED***xels
     */
    ...
    /**
     * The width of the circle (in ***REMOVED***xels).
     */
    protected float mCircleStrokeWidth;

    /**
     * The X radius of the circle (in ***REMOVED***xels).
     */
    protected float mCircleXRadius;

    /**
     * The Y radius of the circle (in ***REMOVED***xels).
     */
    protected float mCircleYRadius;

    /**
     * The radius of the pointer (in ***REMOVED***xels).
     */
    protected float mPointerRadius;

    /**
     * The width of the pointer halo (in ***REMOVED***xels).
     */
    protected float mPointerHaloWidth;

    /**
     * The width of the pointer halo border (in ***REMOVED***xels).
     */
